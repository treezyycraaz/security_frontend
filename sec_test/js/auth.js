...
function authenticateUser(username, password) {
    fetch('http://localhost:8080/api/auth/login', { // Убедитесь, что URL правильный
...
function registerUser(username, password) {
    fetch('http://localhost:8080/api/auth/register', { // Убедитесь, что URL правильный
        method: 'POST', // Метод должен быть POST
        headers: {
            'Content-Type': 'application/json',
        },
...
function fetchUserInfo(token) {
    fetch('http://localhost:8080/api/users/me', { // Убедитесь, что URL правильный
